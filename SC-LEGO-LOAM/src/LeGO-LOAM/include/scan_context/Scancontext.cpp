...
namespace SC2
{
    ...
    MatrixXd SCManager::makeScancontext(pcl::PointCloud<SCPointType> &_scan_down)
    {
        ...
        for (int pt_idx = 0; pt_idx < num_pts_scan_down; pt_idx++)
        {
            ...
            // taking maximum z  这个rangMat设置的参数是最大的z？ 不是深度  SC里面的参数确实是可以自己设置的 z，depth，曲率等
    ...
    MatrixXd SCManager::makeRingkeyFromScancontext(Eigen::MatrixXd &_desc)
    {
        ...
        */
        ...
        for (int row_idx = 0; row_idx < _desc.rows(); row_idx++)
        {
            ...
            invariant_key(row_idx, 0) = curr_row.mean(); //值为 平均
        }
    ...
    MatrixXd SCManager::makeSectorkeyFromScancontext(Eigen::MatrixXd &_desc)
    {
        ...
        */
        Eigen::MatrixXd variant_key(1, _desc.cols()); //这个是一维数组 能够快速匹配
